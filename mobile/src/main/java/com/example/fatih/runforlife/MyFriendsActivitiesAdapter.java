...
public class MyFriendsActivitiesAdapter extends BaseAdapter {
    private List<Activities> mList;
    private LayoutInflater mInfilater;
    private Context context;

    public MyFriendsActivitiesAdapter(Activity activitiy, List<Activities> mList) {
        this.mList = mList;
